            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="{{  route('admin.home') }}" class="header-logo">
                        <img src="/vendors/assets/images/logo.png" alt="logo"
                            class="desktop-logo" />
                        <img src="/vendors/assets/images/logo.png" alt="logo"
                            class="toggle-logo" />
                        <img src="/vendors/assets/images/logo.png" alt="logo"
            ...
            <div class="modal-body">
                <form action="" id="Search" method="GET">
                    <div class="input-group">
                            ...
                            aria-label="Username" />
                            <a href="" class="input-group-text" onclick="event.preventDefault(); document.getElementById('Search').submit();" id="Search-Grid"><i
