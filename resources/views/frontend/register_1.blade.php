                    ...
                    <form action="{{ route('registration.payment') }}" method="post" id="form" onsubmit="return validateForm()">
                        ...
                        <fieldset class="mb-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="Diet" id="" maxlength="300" required cols="30" rows="10" class="form-control"></textarea>
                            </div>
                            <div class="form-group mb-4">
                          ...
                          <input type="text" hidden value="REGULAR DELEGATE " name="register_as">
                        <fieldset class="mb-4">
