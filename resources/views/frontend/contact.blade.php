                       ...
                       <ul>
                          <li>
                             <div class="contact__info-item d-flex align-items-start mb-35">
                                ...
                                <div class="contact__info-text">
                                   <h4>Address</h4>
                                   <p><a target="_blank" href="#">Victoria Island Lagos</a></p>
                          ...
                          <li>
                             <div class="contact__info-item d-flex align-items-start mb-35">
                                ...
                                <div class="contact__info-text">
                                   <h4>Email Address</h4>
                                   <p><a href="mailto:info@tourismafrikanianig.com">info@tourismafrikanianig.com</a></p>
                                </div>
                             </div>
                          </li>
                          <li>
                             <div class="contact__info-item d-flex align-items-start mb-35">
                                ...
                                <div class="contact__info-text">
                                   <h4>Phone</h4>
                                   <p><a href="tel:+2347062081248">+2347062081248</a></p>
                                </div>
                             </div>
                          </li>
                       </ul>
